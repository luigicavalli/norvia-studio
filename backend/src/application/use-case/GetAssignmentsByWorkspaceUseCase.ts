...
interface GetAssignmentsByWorkspaceInput {
    workspaceId: string;
    userId:      string;
}

export class GetAssignmentsByWorkspaceUseCase implements IUseCase<GetAssignmentsByWorkspaceInput, Assignment[]> {
    ...
    public async execute(input: GetAssignmentsByWorkspaceInput): Promise<Assignment[]> {
        ...
        return this.assignmentRepository.findByWorkspace(input.workspaceId);
